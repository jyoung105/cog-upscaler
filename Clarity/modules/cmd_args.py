...
parser.add_argument("--xformers", action='store_true', default=True, help="enable xformers for cross attention layers")
...
parser.add_argument("--opt-sdp-no-mem-attention", default=False, action='store_true', help="prefer scaled dot product cross-attention layer optimization without memory efficient attention for automatic choice of optimization, makes image generation deterministic; requires PyTorch 2.*")
...
parser.add_argument("--opt-channelslast", default=False, action='store_true', help="change memory type for stable diffusion to channels last")
...
parser.add_argument('--vae-path', type=str, default="models/VAE/vae-ft-mse-840000-ema-pruned.safetensors", help='Checkpoint to use as VAE; setting this argument disables all settings related to VAE')
parser.add_argument("--disable-safe-unpickle", action='store_true', help="disable checking pytorch models for malicious code", default=False)
parser.add_argument("--api", action='store_true', help="use api=True to launch the API together with the webui (use --nowebui instead for only the API)")
parser.add_argument("--api-auth", type=str, help='Set authentication for API like "username:password"; or comma-delimit multiple like "u1:p1,u2:p2,u3:p3"', default=None)
parser.add_argument("--api-log", action='store_true', help="use api-log=True to enable logging of all API requests")
parser.add_argument("--nowebui", default=True, action='store_true', help="use api=True to launch the API instead of the webui")
...
parser.add_argument("--skip-version-check", default=True, action='store_true', help="Do not check versions of torch and xformers")
parser.add_argument("--no-hashing", default=True, action='store_true', help="disable sha256 hashing of checkpoints to help loading performance")
